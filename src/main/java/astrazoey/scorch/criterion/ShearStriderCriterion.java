...
public class ShearStriderCriterion extends AbstractCriterion<ShearStriderCriterion.Conditions> {
    @Override
    ...
    public record Conditions(Optional<LootContextPredicate> playerPredicate) implements AbstractCriterion.Conditions {
        public static Codec<ShearStriderCriterion.Conditions> CODEC = LootContextPredicate.CODEC.optionalFieldOf("player")
