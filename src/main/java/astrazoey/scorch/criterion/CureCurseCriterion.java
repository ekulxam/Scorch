...
public class CureCurseCriterion extends AbstractCriterion<CureCurseCriterion.Conditions> {
    @Override
    ...
    public record Conditions(Optional<LootContextPredicate> playerPredicate) implements AbstractCriterion.Conditions {
        public static Codec<CureCurseCriterion.Conditions> CODEC = LootContextPredicate.CODEC.optionalFieldOf("player")
