...
public class ShootBlockCriterion extends AbstractCriterion<ShootBlockCriterion.Conditions> {
    @Override
    ...
    public record Conditions(Optional<LootContextPredicate> playerPredicate) implements AbstractCriterion.Conditions {
        public static Codec<ShootBlockCriterion.Conditions> CODEC = LootContextPredicate.CODEC.optionalFieldOf("player")
