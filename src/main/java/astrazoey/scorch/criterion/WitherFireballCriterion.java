...
public class WitherFireballCriterion extends AbstractCriterion<WitherFireballCriterion.Conditions> {
    @Override
    ...
    public record Conditions(Optional<LootContextPredicate> playerPredicate) implements AbstractCriterion.Conditions {
        public static Codec<WitherFireballCriterion.Conditions> CODEC = LootContextPredicate.CODEC.optionalFieldOf("player")
